 ...
 */
package awesome.generated.tables;


import awesome.generated.Awesome;
import awesome.generated.Keys;
import awesome.generated.tables.records.BlackberryRecord;
...
public class Blackberry extends TableImpl<BlackberryRecord> {
    ...
    private static final long serialVersionUID = -1918735063;
     ...
     */
    public final TableField<BlackberryRecord, String> MODEL = createField("model", org.jooq.impl.SQLDataType.VARCHAR.length(40).nullable(false), this, "");
     ...
     */
    public final TableField<BlackberryRecord, Double> PRICE = createField("price", org.jooq.impl.SQLDataType.DOUBLE.nullable(false), this, "");
